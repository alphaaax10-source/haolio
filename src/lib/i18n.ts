...
export const STRINGS: Dict = {
  ...
  'np.tplBrainstormDesc': { en: 'A radial idea map with 5W+1H prompts, ready to grow.', id: 'Peta ide radial dengan perintah 5W+1H, siap dikembangkan.' },
  'np.tplFlowchart': { en: 'Flowchart', id: 'Diagram alir' },
  'np.tplFlowchartDesc': { en: 'Start, decision and end shapes wired with arrows — trace any process.', id: 'Bentuk mulai, keputusan, dan selesai terhubung panah — petakan proses apa pun.' },
  'np.tplKanban': { en: 'Kanban board', id: 'Papan Kanban' },
  'np.tplKanbanDesc': { en: 'Four columns with cards to drag across as work progresses.', id: 'Empat kolom dengan kartu yang digeser sesuai kemajuan pekerjaan.' },
