...
export const STRINGS: Dict = {
  ...
  'dash.empty': { en: 'No projects yet.', id: 'Belum ada proyek.' },
  ...
  'dash.footer': { en: 'Haolio v{version} · Offline', id: 'Haolio v{version} · Offline' },
  ...
  'np.tplBrainstorm': { en: 'Brainstorm', id: 'Brainstorming' },
  'np.tplBrainstormDesc': { en: 'A radial idea map with 5W+1H prompts.', id: 'Peta ide radial dengan perintah 5W+1H.' },
  'np.tplFlowchart': { en: 'Flowchart', id: 'Diagram alir' },
  'np.tplFlowchartDesc': { en: 'Start, decision and end shapes wired with arrows.', id: 'Bentuk mulai, keputusan, dan selesai terhubung panah.' },
  'np.tplKanban': { en: 'Kanban board', id: 'Papan Kanban' },
  'np.tplKanbanDesc': { en: 'Four columns with cards you can drag between.', id: 'Empat kolom dengan kartu yang bisa digeser antar kolom.' },
  'np.tplSwot': { en: 'SWOT analysis', id: 'Analisis SWOT' },
  'np.tplSwotDesc': { en: 'Four color-coded quadrants: strengths, weaknesses, opportunities, threats.', id: 'Empat kuadran berkode warna: kekuatan, kelemahan, peluang, ancaman.' },
  'np.tplMeeting': { en: 'Meeting notes', id: 'Catatan rapat' },
  'np.tplMeetingDesc': { en: 'Agenda, decisions and action items beside a discussion mind map.', id: 'Agenda, keputusan, dan tindak lanjut di samping peta pikiran diskusi.' },
  ...
  'se.hint': { en: 'Selecting a result centers it on the canvas.', id: 'Memilih hasil akan menampilkannya di tengah kanvas.' },
  ...
  'st.autosaveDesc': { en: 'Keeps saving in the background — snapshots stay manual.', id: 'Tersimpan otomatis di latar belakang — snapshot tetap manual.' },
  ...
  'st.storageText': { en: 'Projects are stored in a local database on this computer.', id: 'Proyek tersimpan di basis data lokal di komputer ini.' },
  ...
  'st.aboutText': { en: 'No account, no cloud, no tracking — everything stays on this PC.', id: 'Tanpa akun, tanpa cloud, tanpa pelacakan — semuanya tersimpan di PC ini.' },
